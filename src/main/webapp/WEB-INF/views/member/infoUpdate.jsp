...
<div class="main-div">
   ...
   <br>
    <form action="/member/infoUpdate" method="post" id="signForm" role="form" onsubmit="return checks()">
       ...
       <label>생년월일</label>
       <div class="form-group">
         <input type="text" class="form-control" name="userBirth" id="userBirth" value="${memVO.userBirth}">
         <div class="check_font" id="userBirthCheck"></div>
       </div>
       
       <label>이메일</label>
       <div class="form-group">
         <input type="email" class="form-control" name="userEmail" id="userEmail" value="${memVO.userEmail}">
         <div class="check_font" id="userEmailCheck"></div>
       </div>
       
       <label>전화번호</label>
       <div class="form-group">
         <input type="text" class="form-control" id="userPhon" name="userPhon" id="userPhon" value="${memVO.userPhon}">
         <div class="check_font" id="userPhonCheck"></div>
       </div>
     
       <label>주소</label>
       <div class="form-group">
         <input type="text" class="form-control" id="sample4_postcode" name="postcode" value="${memVO.postcode}" style="width: 204px; important; display: inline; margin-bottom: 5px;">
         ...
         <input type="text" class="form-control" name="userAddr1" id="sample4_roadAddress" value="${memVO.userAddr1}" style="margin-bottom: 5px; important;" >
         <input type="text" class="form-control" id="sample4_jibunAddress" placeholder="지번주소" style="margin-bottom: 5px; important;" >
         <span id="guide" style="color:#999;display:none"></span>
         <input type="text" class="form-control" name="userAddr2" id="sample4_detailAddress" value="${memVO.userAddr2}" style="width: 176px; important; display: inline; margin-bottom: 5px;">
