...
public class OrderListVO {
	...
	public OrderListVO(String orderId, String userId, String orderRec, String postcode, String userAddr1,
			String userAddr2, String orderPhon, int amount, Timestamp orderDate, String delivery, int orderDetailsNum,
			int gdsNum, int cartStock, String gdsName, String gdsImg, int gdsPrice) {
		super();
